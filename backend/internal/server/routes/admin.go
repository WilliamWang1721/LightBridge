...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	...
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.GET("/appearance", h.Admin.Setting.GetRuntimeAppearance)
		adminSettings.PUT("/appearance", h.Admin.Setting.UpdateRuntimeAppearance)
		adminSettings.DELETE("/appearance", h.Admin.Setting.ResetRuntimeAppearance)
