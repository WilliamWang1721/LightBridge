...
export default {
      ...
      form: {
        ...
        webSearchEmulationHint: 'When enabled, compatible accounts in this channel will intercept web_search requests. Account upstream protocol and capabilities determine whether it applies.',
        ...
        codexImageGenerationBridgeHint: 'When enabled, Codex /responses text requests may be given the image_generation tool. Keep off unless the routed upstream accounts support image generation.',
        ...
        ruleModelPricing: 'Model Pricing',
         noGroupsInChannel: 'No groups selected for this channel',
         unnamed: 'Unnamed',
