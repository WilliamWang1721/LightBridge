...
export default {
    ...
    publicSettingsLoadFailed: 'Login settings could not be loaded. Check your connection and retry.',
    publicSettingsLoading: 'Loading login settings…',
    agreementRequiredForLogin: 'Accept the latest terms before using password or quick login.',
