...
export default {
    ...
    qr: {
      ...
      invalid: 'Payment details are missing or invalid',
    ...
    result: {
      ...
      unverifiable: 'Payment Confirmation Pending',
      unverifiableHint: 'We could not verify the final result yet. Check your orders shortly before trying to pay again.',
      failed: 'Payment Failed',
