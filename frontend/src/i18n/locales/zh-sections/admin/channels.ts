...
export default {
      ...
      form: {
        ...
        webSearchEmulationHint: '开启后，该渠道中具备兼容能力的账号会拦截 web_search 请求，是否生效由账号的实际上游协议与能力决定。',
        webSearchEmulationGlobalDisabled: '请先在系统设置 → 网关 → Web Search 模拟中启用全局开关',
        codexImageGenerationBridge: 'Codex 图片生成桥接',
        codexImageGenerationBridgeHint: '开启后，Codex /responses 文本请求可能会被自动注入 image_generation 工具。仅在实际路由的上游账号支持图片生成时开启。',
