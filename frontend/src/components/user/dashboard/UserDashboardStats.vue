<template>
  ...
  <div class="grid min-w-0 grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
    <!-- Balance -->
    <Card v-if="!isSimple" class="p-4">
      <div class="flex items-center gap-3">
        <div class="rounded-xl bg-[hsl(var(--muted))] p-2 text-[hsl(var(--foreground))]">
        ...
        <div>
          ...
          <p class="text-xl font-bold text-[hsl(var(--foreground))]">${{ formatBalance(balance) }}</p>
    ...
    <Card class="p-4">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xs text-[hsl(var(--muted-foreground))]">{{ stats?.active_api_keys || 0 }} {{ t('common.active') }}</p>
        </div>
      </div>
    </Card>
      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-bold text-gray-900 dark:text-white">
            <span class="text-[hsl(var(--foreground))]" :title="t('dashboard.actual')">${{ formatCost(stats?.today_actual_cost || 0) }}</span>
          ...
          <p class="text-xs">
            ...
            <span class="text-[hsl(var(--foreground))]" :title="t('dashboard.actual')">${{ formatCost(stats?.total_actual_cost || 0) }}</span>
    ...
    <Card class="p-4">
      <div class="flex items-center gap-3">
        ...
        <div class="flex-1">
          ...
          <div class="flex items-baseline gap-2">
            <p class="text-sm font-semibold text-[hsl(var(--foreground))]">{{ formatTokens(stats?.tpm || 0) }}</p>
  ...
  <Card v-if="!isSimple && platformCards.length > 0" class="p-4">
    ...
    <div class="grid min-w-0 grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-4">
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <span class="font-mono text-sm text-[hsl(var(--foreground))]" :title="t('dashboard.actual')">
