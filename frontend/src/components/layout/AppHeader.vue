  ...
  >
    ...
    <div class="flex min-h-20 items-center justify-between px-4 md:px-6">
      ...
      <div class="flex items-center gap-3">
        ...
        <div
          v-if="user"
          class="hidden items-center gap-2 rounded-xl bg-[hsl(var(--secondary))] px-3 py-1.5 sm:flex"
        >
          <svg
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          <button
            ...
            aria-controls="lightbridge-user-menu"
          >
            <div class="flex h-8 w-8 items-center justify-center overflow-hidden rounded-xl bg-[hsl(var(--foreground))] text-sm font-medium text-[hsl(var(--background))]">
              <img
                v-if="avatarUrl"
                :src="avatarUrl"
                :alt="displayName"
          ...
          <transition name="dropdown">
            ...
            >
              ...
              <div v-if="showOnboardingButton" class="border-t border-gray-100 py-1 dark:border-dark-700">
                <button type="button" @click="handleReplayGuide" class="dropdown-item w-full">
                  <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                    <path
